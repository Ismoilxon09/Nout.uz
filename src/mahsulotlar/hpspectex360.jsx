...
function nextrasm10() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/07/Spectre-GOLD-16-4.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm20() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/07/Spectre-GOLD-16-2.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm30() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/07/Spectre-GOLD-16-1.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm40() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/07/Spectre-GOLD-16.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm50() {
    var imgrasm = document.getElementById('imgrasm')
    imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/07/Spectre-GOLD-16-3.jpg')
    imgrasm.style.width = "90%";
    imgrasm.style.transition = "1s";
  }
function sonqush(){
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>HP Spectre x360 16 (i7-13700H)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2023/07/Spectre-GOLD-16-4.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm10} className="img_div101"></div>
                              <div onClick={nextrasm20} className="img_div201"></div>
                              <div onClick={nextrasm30} className="img_div301"></div>
                              <div onClick={nextrasm40} className="img_div401"></div>
                              <div onClick={nextrasm50} className="img_div501"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>HP Spectre x360 16 (i7-13700H)</h3>
                           ...
                           <h5 id='about'>Ekran: 16" 3K+ (3072 x 1920) IPS TS Corning® Gorilla® Glass NBT™ 400 nits, 100% sRGB</h5>
                           <h5 id='about'>Protsessor:   Intel® Core™ i7-13700H (3,7 gigagertsli - 5,0 gigagertsli) (14 yadroli; 20 ta ip)</h5>
                           <h5 id='about'>Videokarta:  Intel Iris Xe Graphics</h5>
                           <h5 id='about'>OZU: 16GB DDR4</h5>
                           <h5 id='about'>Hard: 512GB PCIe® NVMe™ M.2 SSD</h5>
                           <h2>17 347 500 so'm</h2>
                           <span>1350</span>
                             <br />
