...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/03/DellXPS15-9530LaptopPriceinUAE_5.webp')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/03/optimize.webp')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/03/optimize-1-1536x912.webp')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/03/optimize-2-1536x1193.webp')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <div className='divmain'>
                                <Link to="/dell" id='main-link1'>Dell</Link>
                              </div>
                              
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <div className='divmain'>
                                <Link to="/dellxps" id='main-link1'>Dell xps</Link>
                              </div>

                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              
                              <span>Dell XPS 15 9530 (i7-13700H / RTX4050)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2024/03/DellXPS15-9530LaptopPriceinUAE_5.webp" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="nextrasmdell"></div>
                              <div onClick={nextrasm1} className="nextrasmdell1"></div>
                              <div onClick={nextrasm2} className="nextrasmdell2"></div>
                              <div onClick={nextrasm3} className="nextrasmdell3"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Dell XPS 15 9530 (i7-13700H / RTX4050) </h3>
                           <img id='imgdell' src="https://nout.uz/wp-content/uploads/2021/03/dell.png" alt="" />
                             <hr id='hrhp'/>
                           <Link id='TG'><strong><i id='itg' class="fa-brands fa-telegram"></i>TG orqali buyurtma</strong></Link>
                           <h5 id='about'>Ekran: 15,6 FullHD+ IPS (1920x1200)</h5>
                           <h5 id='about'>Protsessor:  Intel Core i7-13700H 1,8 gigagerts - 3,7 gigagerts (14 yadro - 20 ta ip)</h5>
                           <h5 id='about'>Videokarta: Nvidia GeForce RTX4050 6 GB</h5>
                           <h5 id='about'>OZU: 16GB DDR5</h5>
                           <h5 id='about'>Hard: 1TB M.2 NVMe™ PCIe® 4.0 SSD</h5>
                           <h2>23 220 000 so'm</h2>
                           <span>1800</span>
                             <br />
