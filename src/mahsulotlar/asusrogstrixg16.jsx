...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/05/5-1.png')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/05/6.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/05/7.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/05/8.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Asus ROG Strix G16 (i7-13650HX/RTX4080)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2024/05/5-1.png" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="img_div170"></div>
                              <div onClick={nextrasm1} className="img_div220"></div>
                              <div onClick={nextrasm2} className="img_div330"></div>
                              <div onClick={nextrasm3} className="img_div440"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Asus ROG Strix G16 (i7-13650HX/RTX4080)</h3>
                           ...
                           <h5 id='about'>Ekran:  16" WQXGA (2560×1600), IPS 240Hz</h5>
                           <h5 id='about'>Protsessor:  Intel® Core™ i7-13650hx (3.6 GHz – 4.9 GHz) (14 yadroli 20 ip)</h5>
                           <h5 id='about'>Videokarta: GeForce RTX™ 3070 NVIDIA® 8GB/256Bit/GDDR6 </h5>
                           <h5 id='about'>OZU: 16GB DDR5</h5>
                           <h5 id='about'>Hard:1TB M.2 NVMe™ PCIe® 4.0 SSD</h5>
                           <h2>24 510 000 so'm</h2>
                           <span>1900</span>
                             <br />
...
export default Asusrogstrixg16;
