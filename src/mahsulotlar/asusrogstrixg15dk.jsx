                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Asus ROG Strix G15DK (R5-5600X/RTX3070)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        ...
                        <div className="div_malumot">
                           <h3>Asus ROG Strix G15DK (R5-5600X/RTX3070)</h3>
                           ...
                           <h5 id='about'>Videokarta: NVIDIA® GeForce® RTX3070 8GB DDR6 with LHR : 3x DP, 2x HDMI</h5>
...
export default Asusrogstrixg15dk;
