...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/07/42.png')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/07/44.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/07/43.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/07/45.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm4() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/07/46.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <div className='divmain1'>
                                <Link to="/lenovoideapad" id='main-link1'>lenovo-ideapad</Link>
                              </div>
                              
                              <span><i class="fa-solid fa-chevron-right"></i></span>

                              <span>Lenovo IdeaCentre AIO 3 27 (i5-1240P)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2023/06/IdeaCentre-27.jpg" alt="" />
                          </div>
                          
                        </div>
                        <div className="div_malumot">
                           <h3>Lenovo IdeaCentre AIO 3 27 (i5-1240P)</h3>
                           ...
                           <h5 id='about'>Ekran: 27'' FullHD IPS TouchScreen</h5>
                           <h5 id='about'>Protsessor: Intel® Core™ i5-1240p (1.7 GHz - 4.4 GHz) (12 yadro; 16 ip)</h5>
                ...
                <div className='div_fikr'>
                  ...
                  <div className='div_main012 row '>
                       ...
                       <div class="card main16 col-xl-4 lg-4 md-4 sm-12  ">
                         <Link id='a1' to="/lenovolegion5pro" >
...
export default Lenovoideacentre;
