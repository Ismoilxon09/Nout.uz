                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Lenovo Legion 5 T5 (7-5700G/RTX3060)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2021/11/legioen-t1.jpg" alt="" />
                          </div>
                          
                        </div>
                        <div className="div_malumot">
                           <h3>Lenovo Legion 5 T5 (7-5700G/RTX3060)</h3>
                           ...
                           <h5 id='about'>Protsessor: AMD Ryzen ™ 7-5700g (3.80 GHz - 4.60 GHz) (8 yadro-16 ip)</h5>
                           <h5 id='about'>Videokarta:  GeForce® RTX™3060 NVIDIA 12GB/192/GDDR6</h5>
                           <h5 id='about'>OZU: 32GB DDR4</h5>
                           <h5 id='about'>Hard: 1TB PCIe® NVMe™ M.2 SSD</h5>
                           <h2>16 705 000 so'm</h2>
                           <span>1300</span>
                             <br />
...
export default Lenovolegion5t5;
