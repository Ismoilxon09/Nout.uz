...
function nextrasm10() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/03/msi-air-backpack-1.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm20() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/04/msi-air-backpack-1.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm30() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/04/msi-air-backpack-2.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm40() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/04/msi-air-backpack-4-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2021/03/msi-air-backpack-1.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm10} className="img_div111"></div>
                              <div onClick={nextrasm20} className="img_div212"></div>
                              <div onClick={nextrasm30} className="img_div313"></div>
                              <div onClick={nextrasm40} className="img_div414"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>MSI Air Backpack</h3>
                             <hr id='hrhp'/>
                           <Link id='TG'><strong><i id='itg' class="fa-brands fa-telegram"></i>TG orqali buyurtma</strong></Link>
                             <h2 id='narx'>642 500 so'm</h2>
                           <span>50</span>
                             <br />
