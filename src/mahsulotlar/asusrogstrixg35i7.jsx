                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Asus ROG Strix G35CG (i7-11900KF/RTX3080 10GB)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2021/11/asus-rog-intt1.jpg" alt="" />
                          </div>
                          
                        </div>
                        <div className="div_malumot">
                           <h3>Asus ROG Strix G35CG (i7-11900KF/RTX3080 10GB)</h3>
                           ...
                           <h5 id='about'>Protsessor: Intel Core i7-11900kf (3.5 GHz - 5.3 GHz) (8 yadro-16 ip)</h5>
                           <h5 id='about'>Videokarta: GeForce RTX 3080 NVIDIA 10GB/256Bit/GDDR6</h5>
                           <h5 id='about'>OZU: 32GB DDR4</h5>
                           <h5 id='about'>Hard: 1TB PCIe® NVMe™ M.2 SSD</h5>
                           <h2>25 700 000 so'm</h2>
                           <span>2000</span>
                             <br />
...
export default Asusrogstrixg35;
