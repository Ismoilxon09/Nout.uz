...
function nextrasm10() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/03/rog-delta-white1.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm20() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/03/rog-delta-white3.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm30() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/03/rog-delta-white2.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>ROG Delta White Edition</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2022/03/rog-delta-white1.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm10} className="img_div1210"></div>
                              <div onClick={nextrasm20} className="img_div2202"></div>
                              <div onClick={nextrasm30} className="img_div3303"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>ROG Delta White Edition</h3>
                             <hr id='hrhp'/>
                           <Link id='TG'><strong><i id='itg' class="fa-brands fa-telegram"></i>TG orqali buyurtma</strong></Link>
                             <h2 id='narx'>2 377 250 so'm</h2>
                           <span>185</span>
                             <br />
