...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/victus2.jpg')
   imgrasm.style.width = "100%";
   imgrasm.style.translate = "1s";
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/victus5.jpg')
  imgrasm.style.width = "100%";
  imgrasm.style.translate = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/victus1.jpg')
  imgrasm.style.width = "100%";
  imgrasm.style.translate = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/victus6-100x100.jpg')
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>HP Victus 15 (i5-12450H/RTX3050) Uzb</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2021/11/victus2.jpg" alt="" />
                          </div>
                          <div className="rasm_next overflow-x-auto">
                              <div onClick={nextrasm} className="img_0"></div>
                              <div onClick={nextrasm1} className="img_11"></div>
                              <div onClick={nextrasm2} className="img_22"></div>
                              <div onClick={nextrasm3} className="img_33"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           ...
                           <h5 id='about'>Protsessor:  Intel® Core™ i5-12450h (3.3 GHz – 4.4 GHz) (8 yadroli; 12 ip;)</h5>
                           <h5 id='about'>Videokarta: GeForce RTX™ 3050 NVIDIA® 4GB/128Bit/GDDR6</h5>
                           <h5 id='about'>OZU: 8GB DDR4 (16GB=+40 у.е)</h5>
                           <h5 id='about'>Hard:  256GB PCIe® NVMe™ M.2 SSD (512GB SSD=+40 у.е)</h5>
                           <h2>7 482 000 so'm</h2>
                           <span>580</span>
                             <br />
                ...
                <div className='div_fikr'>
                      ...
                      <div className='fikrlar_body'>
                         ...
                         <div className="div_parametrlar">
                            <span>Model</span>
                            <div className="p">
                              <p>HP Victus 15-fa0051TX</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Protsessor</span>
                            <div className="p">
                               <p>Intel® Core™ i5-12450h (3.3 GHz – 4.4 GHz) (8 yadroli; 12 ip;)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Videokarta</span>
                            <div className="p">
                               <p>GeForce RTX™ 3050 NVIDIA® 4GB/128Bit/GDDR6</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                         ...
                         <div className="div_parametrlar">
                            <span>OZU</span>
                            <div className="p">
                               <p>8GB DDR4 (16GB=+40 у.е)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Hard</span>
                            <div className="p">
                               <p>256GB PCIe® NVMe™ M.2 SSD (512GB SSD=+40 у.е)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Сеть</span>
