...
function nextrasm10() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/08/Gateway.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm20() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/08/Gateway3.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm30() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/08/Gateway1.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm40() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/08/Gateway2.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
...
function savatqush() {
  ...
  span1.innerText = span1.innerText +  inpson.value -0;
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <div className='divmain'>
                                <Link to="/acer" id='main-link1'>Acer</Link>
                              </div>
                              
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              
                              <span>Gateway L31 (i7-1255U)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2023/08/Gateway.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm10} className="img_div100"></div>
                              <div onClick={nextrasm20} className="img_div200"></div>
                              <div onClick={nextrasm30} className="img_div300"></div>
                              <div onClick={nextrasm40} className="img_div400"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Gateway L31 (i7-1255U)</h3>
                           <img id='imgplaceholder' src="https://nout.uz/wp-content/uploads/woocommerce-placeholder-300x300.png" alt="" />
                             <hr id='hrhp'/>
                           <Link id='TG'><strong><i id='itg' class="fa-brands fa-telegram"></i>TG orqali buyurtma</strong></Link>
                           <h5 id='about'>Ekran: 14'' FullHD IPS TouchScreen</h5>
                           <h5 id='about'>Protsessor:  Intel® Core™ i7-1255u (3.5 GHz – 4.7 GHz) (10 yadroli 12 ip)</h5>
                           <h5 id='about'>Videokarta:  Intel UHD Graphics</h5>
                           <h5 id='about'>OZU: 8GB DDR4</h5>
                           <h5 id='about'>Hard: 512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</h5>
                           <h2>7 067 500 so'm</h2>
                           <span>550</span>
                             <br />
                ...
                <div className='div_fikr'>
                      ...
                      <div className='fikrlar_body'>
                         ...
                         <div className="div_parametrlar">
                            ...
                            <div className="p">
                               <p>Intel® Core™ i7-1255u (3.5 GHz – 4.7 GHz) (10 yadroli 12 ip)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                         ...
                         <div className="div_parametrlar">
                            <span>Hard</span>
                            <div className="p">
                               <p>512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Сеть</span>
                            <div className="p">
                               <p>Wifi, Bluetooth 5</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Корпус</span>
