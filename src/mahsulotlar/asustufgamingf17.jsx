...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/06/2022-f17-tuf1-300x300.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/06/2022-f17-tuf4-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/06/2022-f17-tuf3-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2022/06/2022-f17-tuf2-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Asus TUF Gaming F17 (i9-13900H/RTX4060)</span>

                           </div>
                   </div>
             </header>
             <main>
                <div className='div_nout01'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2022/06/2022-f17-tuf1-300x300.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="nextrasm1"></div>
                              <div onClick={nextrasm1} className="nextrasm2"></div>
                              <div onClick={nextrasm2} className="nextrasm3"></div>
                              <div onClick={nextrasm3} className="nextrasm4"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Asus TUF Gaming F17 (i9-13900H/RTX4060)</h3>
                           ...
                           <h5 id='about'>Ekran:  17.3'' QHD IPS 240Hz</h5>
                           <h5 id='about'>Protsessor:  Intel Core i9-13900H (1.6GHz - 5.4GHz) (14 yadro - 20 potok)</h5>
                           <h5 id='about'>Videokarta: GeForce RTX4060 8GB/140W/GDDR6</h5>
                           <h5 id='about'>OZU: 16GB DDR4 (32GB=+65 у.е)</h5>
                           <h5 id='about'>Hard: 512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</h5>
                           <h2>16 125 000 so'm</h2>
                           <span>1250</span>
                             <br />
...
export default Asustufgamingf17;
