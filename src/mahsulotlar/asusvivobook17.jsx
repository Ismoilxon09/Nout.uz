...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/07/e1504FA.png')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/01/20.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/01/21.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2024/01/22.png')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Asus VivoBook 17 (i5-13500H)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2024/07/e1504FA.png" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="nextrasm"></div>
                              <div onClick={nextrasm1} className="nextrasm1"></div>
                              <div onClick={nextrasm2} className="nextrasm2"></div>
                              <div onClick={nextrasm3} className="nextrasm3"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Asus VivoBook 17 (i5-13500H) </h3>
                           ...
                           <h5 id='about'>Protsessor: Intel® Core™ i5-13500H (2,6 gigagertsli – 4,7 gigagertsli) (12 yadroli 16 ta ip)</h5>
