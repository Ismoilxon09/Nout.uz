                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Asus TUF Gaming FA507 (R7-7735HS/RTX4060/ENG-RU)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2024/07/42.png" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="img_div011"></div>
                              <div onClick={nextrasm1} className="img_div022"></div>
                              <div onClick={nextrasm2} className="img_div033"></div>
                              <div onClick={nextrasm3} className="img_div044"></div>
                              <div onClick={nextrasm4} className="img_div055"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Asus TUF Gaming FA507 (R7-7735HS/RTX4060/ENG-RU)</h3>
                           ...
                           <h5 id='about'>Protsessor: AMD® Ryzen™ 7-7735hs (3.2 GHz - 4.7 GHz) (8 yadroli; 16 ip;)</h5>
                           <h5 id='about'>Hard: 512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</h5>
                           <h2>12 194 650 so'm</h2>
                           <span>949</span>
                             <br />
