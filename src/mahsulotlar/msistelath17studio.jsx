...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/MSI-Stealth-17-4.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.translate = "1s";
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/MSI-Stealth-17-3.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.translate = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/MSI-Stealth-17-2.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.translate = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/MSI-Stealth-17.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.translate = "1s";
}
function sonqush(){
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>MSI Stealth 17 Studio (i9-13900H/RTX4080)</span>
             ...
             <main>
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2023/03/MSI-Stealth-17-4.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="img_div01"></div>
                              <div onClick={nextrasm1} className="img_div02"></div>
                              <div onClick={nextrasm2} className="img_div03"></div>
                              <div onClick={nextrasm3} className="img_div04"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>MSI Stealth 17 Studio (i9-13900H/RTX4080)</h3>
                           <img  src="https://nout.uz/wp-content/uploads/2021/03/msi.png" alt="" />
                             <hr id='hrhp'/>
                           <Link id='TG'><strong><i id='itg' class="fa-brands fa-telegram"></i>TG orqali buyurtma</strong></Link>
                           <h5 id='about'>Ekran: 17.3</h5>
                           <h5 id='about'>Protsessor:  Intel® Core™ i9-13900h (4.1 GHz – 5.4 GHz) (14 yadro-20 ip)</h5>
                           <h5 id='about'>Videokarta: AMD® Radeon Graphics</h5>
                           <h5 id='about'>Hard: 1TB PCIe® NVMe™ M.2 SSD</h5>
                           <h2>38 537 150 so'm</h2>
                           <span>2999</span>
                             <br />
                ...
                <div className='div_about_pavilion15'>
                      <div className='div_about1'>
                          <p id='p_msi'>MSI Stealth 17 Studio (i9-13900H/RTX4080) noutbukiga bag’ishlangan Nout.uz do’koniga xush kelibsiz – bozordagi eng kuchli va eng ilg’or noutbuk hamyonbop narxda! Agar siz grafik yoki oʻyin ilovalari uchun quvvat va unumdorlikni izlayotgan boʻlsangiz, unda bu noutbuk mukammal tanlovdir.</p>
                          <h4>MSI Stealth 17 Studio noutbuki haqida (i9-13900H/RTX4080)</h4>
                          <p id='p_msi'><Link to="https://ru.msi.com/Laptop/Stealth-17-Studio-A13VX">MSI Stealth 17 Studio</Link> Intel Core i9-13900H protsessoriga ega boʻlib, u operatsion tizimlar, video tahrirlash va boshqa ogʻir vazifalar uchun yuqori unumdorlik va sezgirlikni taʼminlaydi. Shuningdek, noutbuk kuchli NVIDIA GeForce RTX 4080 grafik tezlatkichi bilan jihozlangan bo‘lib, u o‘yinlarda yoki 3D grafikalar bilan ishlashda maksimal natijalarga erishish uchun eng yuqori sifatli grafik va ishlashni ta’minlaydi.</p>
                          <p id="p_msi">17,3 dyuymli 4K UHD piksellar soniga ega ekran bilan MSI Stealth 17 Studio haqiqiy ranglarni takrorlash bilan jonli va boy tasvirni taqdim etadi. Tezkor 1TB SSD xotirasi bilan siz katta hajmdagi fayllarni osongina saqlashingiz va qayta ishlashingiz mumkin. Bundan tashqari, MSI Stealth 17 Studio monitorlar, proyektorlar va qo’shimcha drayvlar kabi tashqi qurilmalarga ulanish uchun kerakli ulagichlarga ega.</p>
                          <p id="p_msi">Ushbu noutbukning boshqa diqqatga sazovor joylari orasida yuqori sifatli RGB yoritgichli klaviatura va MSI’ning noyob Cooler Boost Trinity sovutish tizimi mavjud bo‘lib, u kunning istalgan vaqtida qulay yozishni ta’minlaydi va chidamlilik va maksimal ishlash uchun noutbukni optimal haroratda saqlaydi.</p>
                          <p id="p_msi">MSI Stealth 17 Studio noutbuki eng talabchan dastur va oʻyinlar bilan ishlashda yuqori unumdorlik va qulaylikni qadrlaydigan foydalanuvchilar uchun ideal yechimdir. Uni ish, o‘yin-kulgi yoki ijodiy loyihalar uchun ishlatasizmi, MSI Stealth 17 Studio eng yaxshisiga intiladiganlar uchun ideal.</p>                                               
                          <p id='p_msi'>MSI Stealth 17 Studio noutbukiga (i9-13900H/RTX4080) Toshkent shahriga yetkazib berish bilan hozirdanoq Nout.uz saytimiz orqali buyurtma berishingiz mumkin. Biz eng oson, eng tez va xavfsiz xarid jarayonini kafolatlaymiz va noutbukingizni uyingizga yoki ofisingizga tezda yetkazib beramiz. Hoziroq ushbu kuchli va ilg‘or noutbukni qo‘lga kiritish va unumdorligingizni oshirish imkoniyatini qo‘ldan boy bermang!</p>
                          
                           
                      </div>
                  </div>
                  <div className='div_video'>
                      <div className="div_video1">
                         <iframe id='iframe'  src="https://www.youtube.com/embed/dGO1xHtpF80?si=LERM_CJRLzRC-Rw4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                      </div>
                  </div>
...
export default Msistelath17studio;
