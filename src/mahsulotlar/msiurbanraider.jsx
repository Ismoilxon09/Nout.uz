...
function nextrasm10() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/03/msi-urban-raider-gaming-backpack-4.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm20() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/03/msi-urban-raider-gaming-backpack-1-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm30() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/03/msi-urban-raider-gaming-backpack-2-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm40() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/03/msi-urban-raider-gaming-backpack-3-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function sonqush(){
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>MSI Urban Raider Gaming Laptop Backpack</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2021/03/msi-urban-raider-gaming-backpack-4.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm10} className="img_div121"></div>
                              <div onClick={nextrasm20} className="img_div2220"></div>
                              <div onClick={nextrasm30} className="img_div3330"></div>
                              <div onClick={nextrasm40} className="img_div4440"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>MSI Urban Raider Gaming Laptop Backpack</h3>
                ...
                <div className='div_fikr'>
                      ...
                      <div className='fikrlar_body'>
                         ...
                         <div className="div_parametrlar">
                            <span>Model</span>
                            <div className="p">
                              <p>HP Spectre x360 2in1 16-f2013dx</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                         ...
                         <div className="div_parametrlar">
                            ...
                            <div className="p">
                               <p>16" 3K+ (3072 x 1920) IPS TS Corning® Gorilla® Glass NBT™ 400 nits, 100% sRGB</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                  ...
                  <div className='div13'>
                    <div className='div14'>
                       ...
                       <div class="card main_div017 col-xl-2 lg-6 md-6 sm-6  ">
                            ...
                            <div class="card main_div017 col-xl-2 lg- md-6 sm-6  ">
                           ...
                           <div class="card main_div017 col-xl-2 lg-6 md-6 sm-6  ">
                              <a id='a1' href="/rogdelta">
                                <span id='span' class="woocommerce-loop-product__title">ROG Delta White Edition</span>
                                  <img id='img' src="https://nout.uz/wp-content/uploads/2022/03/rog-delta-white1-300x300.jpg" class="card-img-top" alt="..." />
                                  <div class="cardbody">
                                    <br />
                                    <bdi id='bdi'>2 377 250 so'm</bdi><span id='s' class="woocommerce-Price-amount amount">663 000 so'm&nbsp;</span>
                                     <br />
                                     <span id='id0'>185</span>
