...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/legion-5pro1.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/legion-5pro4.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/legion-5pro3.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2021/11/legion-5pro2-100x100.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Lenovo Legion 5 Pro (R7-5800H/RTX3070)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2021/11/legion-5pro1.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="img_div17"></div>
                              <div onClick={nextrasm1} className="img_div0222"></div>
                              <div onClick={nextrasm2} className="img_div0333"></div>
                              <div onClick={nextrasm3} className="img_div0444"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Lenovo Legion 5 Pro (R7-5800H/RTX3070)</h3>
                           ...
                           <h5 id='about'>Ekran: 16.0</h5>
                           <h5 id='about'>Protsessor:  AMD® Ryzen™ 7-5800h (3.2 GHz - 4.4 GHz) (8 yadroli; 16 ip)</h5>
                           <h5 id='about'>Videokarta: GeForce RTX™ 3070 NVIDIA® 8GB/256Bit/GDDR6 </h5>
                           <h5 id='about'>OZU: 32GB DDR4 </h5>
                           <h5 id='about'>Hard: 512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+80 у.е) </h5>
...
export default Lenovolegion5pro;
