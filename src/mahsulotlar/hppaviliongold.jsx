...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/02/84.png')
   imgrasm.style.width = "90%";
   imgrasm.style.translate = "1s";
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/02/85-1536x1154.png')
  imgrasm.style.width = "90%";
  imgrasm.style.translate = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/02/86-1536x1154.png')
  imgrasm.style.width = "90%";
  imgrasm.style.translate = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/02/87-1536x1154.png')
  imgrasm.style.width = "90%";
  imgrasm.style.translate = "1s";
}
function sonqush(){
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>HP Pavilion 15 Gold (R3-5300U)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2023/02/84-300x300.png" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="img_div"></div>
                              <div onClick={nextrasm1} className="img_div1"></div>
                              <div onClick={nextrasm2} className="img_div2"></div>
                              <div onClick={nextrasm3} className="img_div3"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>HP Pavilion 15 Gold (R3-5300U)</h3>
