...
function nextrasm() {
   ...
   imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/Legion-7-Sim1.jpg')
   imgrasm.style.width = "90%";
   imgrasm.style.transition = "1s"
}
function nextrasm1() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/Legion-7-Sim2.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm2() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/Legion-7-Sim4.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
function nextrasm3() {
  var imgrasm = document.getElementById('imgrasm')
  imgrasm.setAttribute('src', 'https://nout.uz/wp-content/uploads/2023/03/Legion-7-Sim3.jpg')
  imgrasm.style.width = "90%";
  imgrasm.style.transition = "1s";
}
                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span>Lenovo Legion S7 (i7-13700H/RTX4060)</span>
                ...
                <div className='div_nout'>
                     <div className='div_nout1'>
                        <div className="div_rasm">
                          <div className="rasm">
                              <img id='imgrasm' src="https://nout.uz/wp-content/uploads/2023/03/Legion-7-Sim1.jpg" alt="" />
                          </div>
                          <div className="rasm_next">
                              <div onClick={nextrasm} className="img_div0110"></div>
                              <div onClick={nextrasm1} className="img_div0220"></div>
                              <div onClick={nextrasm2} className="img_div0330"></div>
                              <div onClick={nextrasm3} className="img_div0440"></div>
                          </div>
                        </div>
                        <div className="div_malumot">
                           <h3>Lenovo Legion S7 (i7-13700H/RTX4060)</h3>
                           <img src="https://nout.uz/wp-content/uploads/2021/03/lenovo.png" alt="" />
                             <hr id='hrhp'/>
                           <Link id='TG'><strong><i id='itg' class="fa-brands fa-telegram"></i>TG orqali buyurtma</strong></Link>
                           <h5 id='about'>Ekran: 16″ 3.2K (3200 x 2000) IPS, 165 Hz 100% DCl-P3 430 nits</h5>
                           <h5 id='about'>Protsessor: Intel® Core™ i7-13700H (3,7 gigagertsli - 5,0 gigagertsli) (14 yadroli; 20 ta ip)</h5>
                           <h5 id='about'>Videokarta: GeForce™ NVIDIA RTX4060 8 GB/GDDR6</h5>
                           <h5 id='about'>OZU: 16GB DDR5 (32GB=+80 у.е)</h5>
                           <h5 id='about'>Hard: 512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</h5>
                           <h2>20 640 000 so'm</h2>
                           <span>1600</span>
                             <br />
                ...
                <div className='div_fikr'>
                      ...
                      <div className='fikrlar_body'>
                         ...
                         <div className="div_parametrlar">
                            <span>Model</span>
                            <div className="p">
                              <p>Lenovo Legion Slim 7i Gen 8 (16” Intel)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Protsessor</span>
                            <div className="p">
                               <p>Intel® Core™ i7-13700H (3,7 gigagertsli – 5,0 gigagertsli) (14 yadroli; 20 ta ip)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Videokarta</span>
                            <div className="p">
                               <p>GeForce™ NVIDIA RTX4060 8 GB/GDDR6</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Ekran diagonali</span>
                            <div className="p">
                               <p>16″ 3.2K (3200 x 2000) IPS, 165 Hz 100% DCl-P3 430 nits</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                         ...
                         <div className="div_parametrlar">
                            <span>OZU</span>
                            <div className="p">
                               <p>16GB DDR5 (32GB=+80 у.е)</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Hard</span>
                            <div className="p">
                               <p>512GB PCIe® NVMe™ M.2 SSD</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Klaviatura</span>
                            <div className="p">
                               <p>RGB yoritgichi bilan</p>
                            </div>
                         </div>
                         <div className="div_parametrlar">
                            <span>Корпус</span>
                         ...
                         <div className="div_parametrlar">
                            ...
                            <div className="p">
                               <p>
                                 1 Разъем HDMI™ 2.1
                                 2 Переключатель электронного затвора веб-камеры
                                 3 3 x USB-A 3.2 Gen 2 (1 x всегда включен)
                                 4 Устройство чтения SD-карт
                                 5 Подводимая мощность
                                 6 Процессор Intel® Thunderbolt™ 4
                                 7 Комбинированные наушники / микрофон
                                 8 USB-C 3.2 Gen 2 (DisplayPort™ 1.4, питание 135 Вт)
                               </p>   
                            </div>
                         </div>
                      </div>
