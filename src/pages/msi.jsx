            ...
            <div>
             ...
             <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <span>MSI Noutbuklari</span>

                           </div>
                   </div>
             <div className='carusel_div'>
                    <div className='carusel_div1'>
                        <h1>MSI noutbuklari</h1>
                    </div>
                  <div className='carusel_div2 animate__bounceIn animate_animated'>
                    <div id="carouselExampleAutoplaying" class=" carousel slide " data-bs-ride="carousel" >
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img src="https://nout.uz/wp-content/uploads/2024/02/katana-Sword-GF76-i7-13Gen-4060-1970x650-1-1536x507.jpg" class="d-block w-100" alt=""/>
                            </div>
                            <div class="carousel-item ">
                              <img src="https://nout.uz/wp-content/uploads/2023/08/MSI-Stealth-17-Studio-1536x507.jpg" class="d-block w-100" alt=""/>
                            </div>
             ...
             <div className='div_main012 row '>
                       <div class="card main16 col-xl-4 lg-4 md-4 sm-12  ">
                         <Link to="/msicrosshair15" id='a1' >
                           <span id='span'>MSI Crosshair 15 (i7-12700H/RTX3070Ti)</span>
                            <img id='img' src="https://nout.uz/wp-content/uploads/2022/05/grosshare1-300x300.jpg" class="card-img-top" alt="..." />
                            <div class="cardbody">
                              <br />
                              ...
                              <p class="card-text">Intel® Core™ i5-13500H (2,6 gigagertsli – 4,7 gigagertsli) (12 yadroli 16 ta ip)</p>
                                <br />
                              <span>GeForce RTX3070Ti NVIDIA 8GB/256Bit/GDDR6</span>
                                <br />
                                <br />
                              ...
                              <span>1TB PCIe® NVMe™ M.2 SSD</span>
                                <br />
                                <br />
                              <span id='span01'>17 920 000 so'm</span>
                                <br />
                              <span id='span1'>1400</span>
                           ...
                           <span id='span'>MSI Stealth 17 Studio (i9-13900H/RTX4080)</span>
                            ...
                            <div class="cardbody">
                              ...
                              <span>1TB PCIe® NVMe™ M.2 SSD</span>
                                <br />
                                <br />
                              <span id='span01'>38 387 200 so'm</span>
                                <br />
                              <span id='span1'>2999</span>
              ...
              <hr id='hr1'/>
              <div className='about_msi'>
                      <div className='div_about1'>
                          <h2 id='h2'>Toshkentdagi MSI noutbuklari: Nima uchun Nout.uz sizning ideal tanlovingiz?</h2>
                          <p>Kirish:</p>
                          <p>Toshkentda MSI noutbukini tanlashda Nout.uz ishonchli hamkoringizga aylanadi. Ushbu maqolada nima uchun bizning onlayn-do’konimiz etakchi ishlab chiqaruvchidan sifatli uskunalarni sotib olish uchun eng maqbul joy ekanligini aytib beramiz.</p>
                          <p>Nima uchun MSI?</p>
                          <p>MSI (Micro-Star International) yuqori texnologiyali oʻyin va professional noutbuklar ishlab chiqarish boʻyicha jahon yetakchisi hisoblanadi. Brend o’zining innovatsion dizayni, ilg’or texnologiyasi va ishonchliligi bilan mashhur. MSI noutbuklarini tanlaganingizda, siz eng talabchan ehtiyojlaringizni osongina qondira oladigan mahsulotlarga sarmoya kiritasiz.</p>
                          <p>Nout.uz ning afzalliklari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Keng assortiment: Nout.uz har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan qurilmani tanlashi uchun MSI noutbuklarining turli modellarini taqdim etadi.</span>                          
                             <br />
                          <span id='span1'>2.   Kafolatlangan sifat: Biz to’g’ridan-to’g’ri ishlab chiqaruvchilar bilan ishlaymiz, bu mahsulotning haqiqiyligini va yuqori sifat kafolatini ta’minlaydi.</span>
                             <br />
                          <span id='span1'>3.   Raqobatbardosh narxlar: Nout.uz MSI noutbuklari uchun raqobatbardosh narxlarni taklif etadi, bu esa xaridorlarning keng doirasi uchun xarid qilish imkonini beradi.</span>
                             <br />
                          <span id='span1'>4.   Bepul yetkazib berish: Biz sizning vaqtingizni qadrlaymiz, shuning uchun biz Toshkent bo’ylab bepul yetkazib berishni ta’minlaymiz, bu esa uskunani xarid qilish qulayligini ta’minlaydi.</span>
                             <br />
                          <span id='span1'>5.   Moslashuvchan to’lov tizimi: Bizda turli xil to’lov opsiyalari mavjud, bu esa buyurtma berish jarayonini tez va qulay qiladi.</span>
                        </div> 
                          <h4>Nega Toshkentda?</h4>
                             <br />
                          <p>Toshkent ilg‘or texnologiyalar talab qilinadigan dinamik shahardir. MSI noutbuklari zamonaviy hayotga bemalol moslashib, ishlash, o‘rganish va o‘yin uchun ishonchli vositalarni taqdim etadi.</p>
                          <div className='span'> 
                          <span id='span1'>1.Keng tanlov: Biz har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan mukammal noutbukni topa olishini ta’minlash uchun turli xil Acer Nitro modellarini taklif etamiz.</span>                          
                             <br />
                          <span id='span1'>2.Kafolatlangan sifat: Biz faqat rasmiy etkazib beruvchilar bilan hamkorlik qilamiz va mahsulotlarning o’ziga xosligini kafolatlaymiz. Nout.uz saytida Acer Nitro xarid qilish orqali siz ishonchli va sifatli qurilmaga ega bo’lasiz.</span>
                             <br />
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida Acer noutbukini xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
