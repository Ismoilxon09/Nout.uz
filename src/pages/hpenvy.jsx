             ...
             <main>
                <div className='carusel_div'>
                    <div className='carusel_div1'>
                        <h1>HP ENVY (x360 ) – HP Envy noutbuklari</h1>
                    </div>
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                       <img src="https://nout.uz/wp-content/uploads/2023/10/HP-ENVY-1970x650-1-1536x507.jpg" alt="" />
                    </div>
                 </div>

                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda HP ENVY noutbuklarini xarid qiling: Sizning oʻyin va ajoyib ishlash olamiga chiptangiz</h2>
                        ...
                        <div className='span'> 
                          <span id='span1'>1.   Ishonchlilik: HP ENVY yuqori sifatli komponentlar yordamida ishlab chiqarilgan va chidamlilik va ishonchlilik uchun qattiq sinovlardan o’tgan. Ular uzoq muddatli foydalanish uchun mo’ljallangan.</span>                          
                             <br />
                          <span id='span1'>2.   Ishlash: HP ENVY noutbuklari kuchli Intel yoki AMD protsessorlari, yuqori unumdor grafik kartalar va ilovalar va vazifalarning uzluksiz ishlashini ta’minlash uchun keng RAM bilan jihozlangan.</span>
                             <br />
                          <span id='span1'>3.   Dizayn va uslub: HP ENVY noutbuklarining zamonaviy va nafis dizayni ularni ish va o‘yin uchun jozibador qiladi.</span>
                             <br />
                          <span id='span1'>4.   Modellarning xilma-xilligi: HP ENVY har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan mukammal noutbukni topishini ta’minlash uchun keng turdagi modellarni taklif etadi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda HP ENVY sotib olish uchun ishonchli tanlovdir?</h4>
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida HP ENVY xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
