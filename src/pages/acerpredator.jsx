        ...
        <div>
            <header>
             ...
             <main>
                ...
                <hr id='hr01'/>
                <hr id='hr02'/>
                <div className='about_predator'>
                      <div className='div_about1'>
                          <h2 id='h2'>                          Nout.uz saytida Toshkentda Acer Predator noutbuklarini xarid qiling: Sizning mutlaq o‘yin hukmronligi sari yo‘lingiz</h2>
                          ...
                          <h4>Acer Predator: O’yin kuchi</h4>
                          <p>Acer Predator noutbuklari haqiqiy o’yinchilar va maksimal ishlashni talab qiladigan professionallar uchun mo’ljallangan. Acer Predator geymerlar uchun eng zo’r tanlov bo’lishining bir necha sabablari:</p>
                        <div className='span'> 
                          ...
                          <h4>Nega Nout.uz Toshkentda Acer Predator sotib olish uchun ishonchli tanlovdir?</h4>
