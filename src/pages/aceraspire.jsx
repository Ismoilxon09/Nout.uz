             ...
             <main>
                <div className='carusel_div'>
                    ...
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                       <img src="https://nout.uz/wp-content/uploads/2022/06/aspire-1536x507.jpg" alt="" />
                    </div>
                 </div>
                   <hr id='about_hr'/>
                <div className='about_aspire'>
                      <div className='div_about1'>
                          ...
                          <h4>Acer Aspire: Ishonchlilik va ishlash</h4>
                          <p>Acer Aspire noutbuklari ishonchlilik va ishlashning sinonimidir. Ularning mashhurligining bir necha sabablari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Ishonchlilik: Acer Aspire yuqori sifatli komponentlar yordamida ishlab chiqarilgan va chidamlilik va ishonchlilik uchun qattiq sinovlardan o’tgan. Ular uzoq muddatli foydalanish uchun mo’ljallangan.</span>                          
                             <br />
                          <span id='span1'>2.   Ishlash: Acer Aspire noutbuklari kuchli Intel yoki AMD protsessorlari, yuqori unumdor grafik kartalar va ilovalar va vazifalarning uzluksiz ishlashini ta’minlash uchun keng RAM bilan jihozlangan.</span>
                             <br />
                          <span id='span1'>3.   Dizayn va uslub: Acer Aspire noutbuklarining zamonaviy va nafis dizayni ularni ish va o‘yin uchun jozibador qiladi.</span>
                             <br />
                          <span id='span1'>4.   Modellarning xilma-xilligi: Acer Aspire har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan mukammal noutbukni topishini ta’minlash uchun keng turdagi modellarni taklif etadi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Acer Aspire sotib olish uchun ishonchli tanlovdir?</h4>
