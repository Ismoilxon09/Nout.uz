                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <div className='divmain1'>
                                <Link to="/hp" id='main-link1'>HP Noutbuklari</Link>
                              </div>
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <span>Hp Spectre-HP noutbuklari spektri</span>
             ...
             <main>
                <div className='carusel_div'>
                    <div className='carusel_div1'>
                        <h1>Hp Spectre-HP noutbuklari spektri</h1>
                    </div>
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                         <div class="carousel-inner">
                           <div class="carousel-item active">
                             <img src="https://nout.uz/wp-content/uploads/2023/12/Spectre-16-1970x650-i7-1-1536x507.jpg" class="carusel_div01 " alt=""/>
                           </div>
                           <div class="carousel-item">
                             <img src="https://nout.uz/wp-content/uploads/2023/12/Spectre-14-2023-1970x650-1-1536x507.jpg" class="carusel_div01 " alt=""/>
                           </div>
                           
                         </div>
                         <button id='carusel_btn' class="carousel-control-prev" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="prev">
                           <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                           <span class="visually-hidden">Previous</span>
                         </button>
                         <button id='carusel_btn' class="carousel-control-next" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="next">
                ...
                <div className='div_about_victus'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda HP  noutbuklarini xarid qiling: Sizning oʻyin va ajoyib ishlash olamiga chiptangiz</h2>
                          <p>Agar siz o’yin o’ynash va mashaqqatli vazifalar uchun mukammal hamroh qidirsangiz, Acer Nitro noutbuklari sizning eng yaxshi tanlovingizdir. Ushbu maqolada Acer Nitro noutbuklarining afzalliklari va nima uchun Nout.uz Toshkentda ushbu modelni xarid qilishda ishonchli hamkoringiz ekanligi haqida gapirib beramiz.</p>
                          <h4>HP : Ishonchlilik va ishlash</h4>
                          <p>HP  noutbuklari ishonchlilik va ishlashning sinonimidir. Ularning mashhurligining bir necha sabablari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Ishonchlilik: HP  yuqori sifatli komponentlar yordamida ishlab chiqarilgan va chidamlilik va ishonchlilik uchun qattiq sinovlardan o’tgan. Ular uzoq muddatli foydalanish uchun mo’ljallangan.</span>                          
                             <br />
                          <span id='span1'>2.   Ishlash: HP  noutbuklari kuchli Intel yoki AMD protsessorlari, yuqori unumdor grafik kartalar va ilovalar va vazifalarning uzluksiz ishlashini ta’minlash uchun keng RAM bilan jihozlangan.</span>
                             <br />
                          <span id='span1'>3.   Dizayn va uslub: HP  noutbuklarining zamonaviy va nafis dizayni ularni ish va o‘yin uchun jozibador qiladi.</span>
                             <br />
                          <span id='span1'>4.   Modellarning xilma-xilligi: HP  har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan mukammal noutbukni topishini ta’minlash uchun keng turdagi modellarni taklif etadi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda HP  sotib olish uchun ishonchli tanlovdir?</h4>
                          <p>Nout.uz — Toshkent shahrida yuqori sifatli elektronika, jumladan, Acer Nitro noutbuklarini sotishga ixtisoslashgan onlayn-do‘kon. Mana nima uchun Nout.uz sizning ideal hamkoringiz:</p>
                          <div className='span'> 
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida HP  xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
                                   <span id='span1'>1.<Link to="/">Nout.uz</Link> saytimizga tashrif buyuring.</span>                          
                                      <br />
                                   <span id='span1'>2.Sizni qiziqtirgan HP  modelini tanlang.</span>
                                      <br />
                                   ...
                                   <span id='span1'>4.Qulay to’lov va yetkazib berish usulini tanlang.</span>
                                     <br />
                                   <span id='span1'>5.Buyurtma kelishini kuting va HP sifatidan bahramand bo’ling.</span>
                                </div> 
                                 <br />
                            <h4>Xulosa</h4>
