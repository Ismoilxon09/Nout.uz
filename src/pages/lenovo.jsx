...
const Lenovo = () => {
    return (
        <div>
             ...
             <main>
                <div className='acer'>
                    ...
                    <div className='acer_nitro'>
                        <Link to="/lenovoideapad">
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2023/02/ideapad-brand-1970x650-1-1-1536x507.jpg" alt="" />
                        </Link>
                    </div>
                </div>
                <div className='acer_aspire'>
                    <div className='acer_aspire1'>
                       <Link to="/lenovothinkpad">
                ...
                <div className='acer_aspire'>
                    <div className='acer_aspire1'>
                       <Link to="/lenovoyoga">
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2023/05/yoga-1536x507.jpg" alt="" />
                       </Link>
                    </div>
                </div>
                ...
                <div className='acer_aspire'>
                    <div className='acer_aspire1'>
                       <Link to="/">
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2023/05/legion-tower-1-1536x507.jpg" alt="" />
                       </Link>
                    </div>
                </div>
                  <hr id='hr1'/>
                <div className='div_main012 row '>
                       ...
                       <div class="card main16 col-xl-4 lg-4 md-4 sm-12  ">
                         <a id='a1' href="/lenovoideacentre">
                           <span id='span'>Lenovo IdeaCentre AIO 3 27 (i5-1240P)</span>
                            <img id='img1' src="https://nout.uz/wp-content/uploads/2023/06/IdeaCentre-27-300x300.jpg" class="card-img-top" alt="..." />
                            <div class="cardbody">
                              <br />
                              <span>27'' FullHD IPS TouchScreen</span>
                                 <br />
                                 <br />
                              <p class="card-text">Intel® Core™ i5-1240p (1.7 GHz - 4.4 GHz) (12 yadro; 16 ip)
                              </p>
                              ...
                              <span>512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</span>
                                <br />
                                <br />
                              <span id='span01'>12 800 000 so'm</span>
                                <br />
                          ...
                          <a id='a1' href="/lenovolegions7">
                           <span id='span'>Lenovo Legion S7 (i7-13700H/RTX4060)</span>
                            <img id='img1' src="https://nout.uz/wp-content/uploads/2023/03/Legion-7-Sim1-300x300.jpg" class="card-img-top" alt="..." />
                            <div class="cardbody">
                              <br />
                              <span>16″ 3.2K (3200 x 2000) IPS, 165 Hz 100% DCl-P3 430 nits</span>
                                <br />
                                <br />
                              <p class="card-text">Intel® Core™ i7-13700H (3,7 gigagertsli - 5,0 gigagertsli) (14 yadroli; 20 ta ip)</p>
                              <span>GeForce™ NVIDIA RTX4060 8 GB/GDDR6</span>
                                <br />
                                <br />
                              <span>16GB DDR5 (32GB=+80 у.е)</span>
                                <br />
                                <br />
                              <span>512GB PCIe® NVMe™ M.2 SSD (1TB SSD=+50 у.е)</span>
                                <br />
                                <br />
                              <span id='span01'>20 480 000 so'm</span>
                                <br />
                              <span id='span1'>1600</span>
             ...
             <footer className='footer_lenovo'> 
