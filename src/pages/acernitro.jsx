                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <div className='divmain1'>
                                <Link to="/acer" id='main-link1'>Acer Noutbuklari</Link>
                              </div>
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <span>Racer Nitro-Acer Nitro Noutbuklari</span>
             ...
             <main>
                <div className='carusel_div'>
                    <div className='carusel_div1'>
                        <h1>Racer Nitro-Acer Nitro Noutbuklari</h1>
                    </div>
                  <div className='carusel_div2 animate__bounceIn animate_animated'>
                    <div id="carouselExampleAutoplaying" class=" carousel slide " data-bs-ride="carousel" >
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img src="https://nout.uz/wp-content/uploads/2023/08/Acer-Nitro-i7-1970x650-1-1536x507.jpg" class="d-block w-100" alt=""/>
                            </div>
                            <div class="carousel-item active">
                              <img src="https://nout.uz/wp-content/uploads/2023/08/Acer-Nitro-5-17-1970x650-1-1536x507.jpg" class="d-block w-100" alt=""/>
                            </div>
                ...
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda Acer Nitro noutbuklarini xarid qiling: Sizning oʻyin va ajoyib ishlash olamiga chiptangiz</h2>
                          ...
                          <h4>Acer Nitro: O’yin dunyosida</h4>
                          <p>Acer Nitro noutbuklari geymerlar va maksimal ishlashni qadrlaydiganlar ehtiyojlarini hisobga olgan holda ishlab chiqilgan. Mana nima uchun ular juda mashhur:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Oʻyin samaradorligi: Acer Nitro kuchli Intel Core yoki AMD Ryzen protsessorlari, yuqori unumdorlikdagi NVIDIA GeForce grafik kartalari va keng operativ xotira bilan jihozlangan boʻlib, sizga yuqori grafik sozlamalarida oʻyinlardan bahramand boʻlish va resurs talab qiluvchi ilovalarni ishga tushirish imkonini beradi.</span>                          
                             <br />
                          <span id='span1'>2.   Tez displey: Acer Nitroning ko‘p modellarida kechikishlarsiz silliq va real o‘yin uchun tez, yuqori yangilanish tezligi displeylari mavjud.</span>
                             <br />
                          <span id='span1'>3.   Tasvir sifati: Acer Nitro displeylarining yuqori aniqligi va jonli ranglari ularni geymerlar va multimedia kontenti yaratuvchilari uchun ajoyib tanlov qiladi.</span>
                             <br />
                          <span id='span1'>4.   O’ylangan dizayn: Acer Nitro noutbuklarining nafis va zamonaviy dizayni ularga xarakter beradi va ularni nafaqat samarali, balki jozibali qiladi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Acer Nitro sotib olish uchun ishonchli tanlovdir?</h4>
