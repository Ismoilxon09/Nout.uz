            ...
            <header>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <div className='divmain1'>
                                <Link to="/dell" id='main-link1'>Dell Noutbuklari</Link>
                              </div>
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <span>Dell XPS</span>
             ...
             <main>
                <div className='carusel_div'>
                    <div className='carusel_div1'>
                        <h1>Dell XPS</h1>
                    </div>
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                       <img src="https://nout.uz/wp-content/uploads/2022/06/xps-2-2-1536x507.jpg" alt="" />
                    </div>
                </div>
                <hr id='hr1'/>
                <div className='div_main012 row '>
                       <div class="card main16 col-xl-4 lg-4 md-4 sm-12  ">
                         <a id='a1' href="/dellxps15">
                           <span id='span'>Dell XPS 15 9530 (i7-13700H / RTX4050)</span>
                            <img id='img1' src="https://nout.uz/wp-content/uploads/2024/03/DellXPS15-9530LaptopPriceinUAE_5-300x300.webp" class="card-img-top" alt="..." />
                            <div class="cardbody">
                              <br />
                              <span>15,6 FullHD+ IPS (1920x1200)</span>
                                 <br />
                                 <br />
                              <p class="card-text">Intel Core i7-13700H 1,8 gigagerts - 3,7 gigagerts (14 yadro - 20 ta ip)</p>
                              <span>Nvidia GeForce RTX4050 6 GB</span>
                                <br />
                                <br />
                              <span>16GB DDR5</span>
                                <br />
                ...
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda Dell XPS noutbuklarini xarid qiling: Sizning oʻyin va ajoyib ishlash olamiga chiptangiz</h2>
                          <p>Agar siz o’yin o’ynash va mashaqqatli vazifalar uchun mukammal hamroh qidirsangiz, Dell XPS noutbuklari sizning eng yaxshi tanlovingizdir. Ushbu maqolada Dell XPS noutbuklarining afzalliklari va nima uchun Nout.uz Toshkentda ushbu modelni xarid qilishda ishonchli hamkoringiz ekanligi haqida gapirib beramiz.</p>
                          <h4>Dell XPS: O’yin dunyosida</h4>
                          <p>Dell XPS noutbuklari geymerlar va maksimal ishlashni qadrlaydiganlar ehtiyojlarini hisobga olgan holda ishlab chiqilgan. Mana nima uchun ular juda mashhur:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Oʻyin samaradorligi: Dell XPS kuchli Intel Core yoki AMD Ryzen protsessorlari, yuqori unumdorlikdagi NVIDIA GeForce grafik kartalari va keng operativ xotira bilan jihozlangan boʻlib, sizga yuqori grafik sozlamalarida oʻyinlardan bahramand boʻlish va resurs talab qiluvchi ilovalarni ishga tushirish imkonini beradi.</span>                          
                             <br />
                          <span id='span1'>2.   Tez displey: Dell XPSning ko‘p modellarida kechikishlarsiz silliq va real o‘yin uchun tez, yuqori yangilanish tezligi displeylari mavjud.</span>
                             <br />
                          <span id='span1'>3.   Tasvir sifati: Dell XPS displeylarining yuqori aniqligi va jonli ranglari ularni geymerlar va multimedia kontenti yaratuvchilari uchun ajoyib tanlov qiladi.</span>
                             <br />
                          <span id='span1'>4.   O’ylangan dizayn: Dell XPS noutbuklarining nafis va zamonaviy dizayni ularga xarakter beradi va ularni nafaqat samarali, balki jozibali qiladi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Dell XPS sotib olish uchun ishonchli tanlovdir?</h4>
                          <p>Nout.uz — Toshkent shahrida yuqori sifatli elektronika, jumladan, Dell XPS noutbuklarini sotishga ixtisoslashgan onlayn-do‘kon. Mana nima uchun Nout.uz sizning ideal hamkoringiz:</p>
                          <div className='span'> 
                          <span id='span1'>1.Keng tanlov: Biz har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan mukammal noutbukni topa olishini ta’minlash uchun turli xil Dell XPS modellarini taklif etamiz.</span>                          
                             <br />
                          <span id='span1'>2.Kafolatlangan sifat: Biz faqat rasmiy etkazib beruvchilar bilan hamkorlik qilamiz va mahsulotlarning o’ziga xosligini kafolatlaymiz. Nout.uz saytida Dell XPS xarid qilish orqali siz ishonchli va sifatli qurilmaga ega bo’lasiz.</span>
                             <br />
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida Dell XPS xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
                                   <span id='span1'>1.<Link to="/">Nout.uz</Link> saytimizga tashrif buyuring.</span>                          
                                      <br />
                                   <span id='span1'>2.Sizni qiziqtirgan DEll modelini tanlang.</span>
                                      <br />
                                   ...
                                   <span id='span1'>4.Qulay to’lov va yetkazib berish usulini tanlang.</span>
                                     <br />
                                   <span id='span1'>5.Buyurtma kelishini kuting va Dell sifatidan bahramand bo’ling.</span>
                                </div> 
                                 <br />
                            <h4>Xulosa</h4>
                            <span>Nout.uz saytida Dell noutbukini xarid qilish sizning ishonchlilik va innovatsiyalar sari qadamdir. Sifatli va ishonchli noutbuk olish imkoniyatini boy bermang. Bizning veb-saytimizga tashrif buyuring va bugun buyurtma bering!</span>
