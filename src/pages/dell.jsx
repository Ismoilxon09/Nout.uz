             ...
             <main>
                <div className='acer'>
                    ...
                    <div className='acer_nitro'>
                        <Link to="/dellxps">
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2022/06/xps-2-2-1536x507.jpg" alt="" />
                        </Link>
                    </div>
                </div>
                <div className='acer_aspire'>
                    <div className='acer_aspire1'>
                       <Link to="/dellinspiron">
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2022/06/inspiron3-1536x507.jpg" alt="" />
                       </Link>
                    </div>
                </div>
                  <hr id='razerhr'/>
                  <hr id='razerhr'/>
                  <div className='razer_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Dell noutbuklari Toshkent va Oʻzbekistonda:</h2>
                          <p>Innovatsiya, ishlash va ishonchlilik</p>
                          <p>Nout.uz dagi Dell sahifasiga xush kelibsiz – zamonaviy texnologiyalar olamidagi ishonchli hamkoringiz. Dell shunchaki brend emas, u noutbuklar dunyosida sifat va ishonchlilik standartidir. Keling, nima uchun Dell noutbuklari butun dunyo bo’ylab minglab foydalanuvchilarning tanloviga aylanganini batafsil ko’rib chiqaylik.</p>
                          
                          <span>Murosasiz ishlash: Dell noutbuklari ilg’or texnologiyalar va kuchli komponentlar bilan hayotingizga ajoyib unumdorlik keltiradi. Eng yangi avlod protsessorlari har qanday sharoitda tez javob berish va muammosiz ishlashni kafolatlaydi. Noutbukingiz eng qiyin vazifalarni bajara olishiga ishonch hosil qiling.</span>
                             <br />
                             <br />
                          <span>Foydalanuvchi uchun innovatsiya: Dell nafaqat tendentsiyalarga amal qiladi, balki ularni o’rnatadi. Noutbukdan foydalanishni iloji boricha qulay va samarali qilish imkonini beruvchi ilg‘or innovatsiyalardan bahramand bo‘ling. Dell o’ta nozik dizaynlardan tortib ilg’or sovutish yechimlarigacha kelajak texnologiyasini yaratmoqda.</span> 
                             <br />
                             <br />
                          <span>Foydalanuvchi uchun innovatsiya: Dell nafaqat tendentsiyalarga amal qiladi, balki ularni o’rnatadi. Noutbukdan foydalanishni iloji boricha qulay va samarali qilish imkonini beruvchi ilg‘or innovatsiyalardan bahramand bo‘ling. Dell o’ta nozik dizaynlardan tortib ilg’or sovutish yechimlarigacha kelajak texnologiyasini yaratmoqda.</span>
                             <br />
                             <br />
                          <span>Elegant dizayn: noutbuklar dunyosida Dell nafislikning sinonimidir. Yupqa ekranli ramkalar, bardoshli materiallar, ajoyib bezaklar – har bir tafsilot eng kichik nuanslargacha o’ylangan. Dell noutbukiga egalik qilish nafaqat tajriba, balki tashqi ko’rinishingizga zamonaviy qo’shimchadir.</span>
                             <br />
                             <br />
                          <span>Siz ishonishingiz mumkin bo’lgan ishonchlilik: Dell o’z mahsulotlarining ishonchliligi ortida turibdi. Har bir noutbuk eng yuqori sifat standartlariga javob berish uchun qattiq sinovdan o’tadi. Dell sizning kundalik vazifalaringizda ishonchli hamkor bo’lib, ko’p yillar davomida sizga xizmat qilishiga ishonishingiz mumkin.</span>
                             <br />
                             <br />
                          <span>Nout.uz dan Dell ni tanlang: Nout.uz sizga maksimal foyda bilan Dell noutbuklarini xarid qilish imkoniyatini beradi. Bizning maslahatchilarimiz sizning ehtiyojlaringizga mos modelni tanlashda yordam berishga tayyor. Uslub, ishlash va ishonchlilikni muvaffaqiyatli birlashtirgan Dell noutbuklari sifatni qadrlaydiganlar uchun ideal tanlovdir. Dell va Nout.uz bilan kelajakka ishonch bilan xarid qiling!</span>
