             ...
             <main>
                <div className='acer'>
                    ...
                    <div className='acer_nitro'>
                        <Link>
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2023/05/thinkpad-1-1536x507.jpg" alt="" />
                        </Link>
                    </div>
                </div>
                   <hr id='about_hr'/>
                ...
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>                          Nout.uz saytida Toshkentda Lenovo Thinkpad noutbuklarini xarid qiling: Sizning mutlaq o‘yin hukmronligi sari yo‘lingiz</h2>
                          ...
                          <h4>Lenovo Thinkpad: O’yin kuchi</h4>
                          <p>Lenovo Thinkpad noutbuklari haqiqiy o’yinchilar va maksimal ishlashni talab qiladigan professionallar uchun mo’ljallangan. Acer Predator geymerlar uchun eng zo’r tanlov bo’lishining bir necha sabablari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Kuchli komponentlar: Acer Predator noutbuklari kuchli Intel Core i7/i9 yoki AMD Ryzen protsessorlari, NVIDIA GeForce RTX grafik kartalari, katta hajmdagi operativ xotira va tezkor SSD disklari bilan jihozlangan. Bu hatto eng talabchan o’yinlarda ham ajoyib ishlashni ta’minlaydi.</span>                          
                             <br />
                          <span id='span1'>2.   Tez ekran: Acer Predator modellarining ko’pchiligi yuqori yangilanish tezligiga ega tezkor displeylarga ega bo’lib, sizga kechikish yoki yirtilishsiz silliq o’yindan zavqlanish imkonini beradi.</span>
                             <br />
                          <span id='span1'>3.   Innovatsion dizayn: Acer Predators tajovuzkor chiziqlar va RGB yoritgichli haqiqiy san’at asarlari bo’lib, ularni nafaqat kuchli, balki zamonaviy ham qiladi.</span>
                             <br />
                          <span id='span1'>4.   Aqlli oʻyin funksiyalari: Acer Predator’ning koʻpgina modellari sovutish tizimlari, dasturlashtiriladigan kalitlar va boshqalar kabi innovatsion oʻyin funksiyalari bilan jihozlangan.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Lenovo Thinkpad sotib olish uchun ishonchli tanlovdir?</h4>
