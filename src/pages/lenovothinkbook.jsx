                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <div className='divmain01'>
                                <Link to="/lenovo" id='main-link1'>Lenovo</Link>
                              </div>
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <span>Thinkbook</span>
             ...
             <main>
                <div className='acer'>
                    ...
                    <div className='acer_nitro'>
                        <Link>
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2023/05/thinkbook-1536x507.jpg" alt="" />
                        </Link>
                    </div>
                </div>
                <hr id='hr1'/>
                ...
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>                          Nout.uz saytida Toshkentda Lenovo Thinkbook noutbuklarini xarid qiling: Sizning mutlaq o‘yin hukmronligi sari yo‘lingiz</h2>
                          <p>Agar siz oʻyin dunyosida beqiyos quvvat, unumdorlik va uslubni taklif etuvchi noutbuk izlayotgan boʻlsangiz, unda Acer Predator noutbuklari sizning ideal tanlovingizdir. Ushbu maqolada biz sizga Acer Predator noutbuklarining afzalliklari va nima uchun Nout.uz Toshkentda ushbu brendni xarid qilishda ishonchli hamkoringiz ekanligi haqida gapirib beramiz.</p>
                          <h4>Lenovo Thinkbook: O’yin kuchi</h4>
                          <p>Lenovo Thinkbook noutbuklari haqiqiy o’yinchilar va maksimal ishlashni talab qiladigan professionallar uchun mo’ljallangan. Acer Predator geymerlar uchun eng zo’r tanlov bo’lishining bir necha sabablari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Kuchli komponentlar: Lenovo Thinkbook kuchli Intel Core i7/i9 yoki AMD Ryzen protsessorlari, NVIDIA GeForce RTX grafik kartalari, katta hajmdagi operativ xotira va tezkor SSD disklari bilan jihozlangan. Bu hatto eng talabchan o’yinlarda ham ajoyib ishlashni ta’minlaydi.</span>                          
                             <br />
                          <span id='span1'>2.   Tez ekran: Lenovo Thinkbook modellarining ko’pchiligi yuqori yangilanish tezligiga ega tezkor displeylarga ega bo’lib, sizga kechikish yoki yirtilishsiz silliq o’yindan zavqlanish imkonini beradi.</span>
                             <br />
                          <span id='span1'>3.   Innovatsion dizayn: Lenovo Thinkbook tajovuzkor chiziqlar va RGB yoritgichli haqiqiy san’at asarlari bo’lib, ularni nafaqat kuchli, balki zamonaviy ham qiladi.</span>
                             <br />
                          <span id='span1'>4.   Aqlli oʻyin funksiyalari: Lenovo Thinkbook koʻpgina modellari sovutish tizimlari, dasturlashtiriladigan kalitlar va boshqalar kabi innovatsion oʻyin funksiyalari bilan jihozlangan.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Lenovo Thinkbook sotib olish uchun ishonchli tanlovdir?</h4>
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida Lenovo Thinkbook noutbukini xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
                                 ...
                                 <br />
                            <h4>Xulosa</h4>
                            <span>Nout.uz saytida Lenovo Thinkbook noutbukini xarid qilish sizning ishonchlilik va innovatsiyalar sari qadamdir. Sifatli va ishonchli noutbuk olish imkoniyatini boy bermang. Bizning veb-saytimizga tashrif buyuring va bugun buyurtma bering!</span>
