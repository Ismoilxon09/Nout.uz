                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span><i class="fa-solid fa-chevron-right"></i></span>
                              <span>Hp Victus-HP Victus Noutbuklari</span>
             ...
             <main>
                <div className='carusel_div'>
                    <div className='carusel_div1'>
                        <h1>Hp Victus-HP Victus Noutbuklari</h1>
                    </div>
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                       <img src="https://nout.uz/wp-content/uploads/2023/11/OMEN-1970x650-1-1536x507.jpg" alt="" />
                    </div>
                 </div>
                 <hr id='hr1'/>
                           ...
                           <span id='span'>HP Victus 15 (i5-12450H/RTX3050) Uzb</span>
                            ...
                            <div class="cardbody">
                              ...
                              <span>15.6</span>
                                 <br />
                                 <br />
                              <p class="card-text">15.6'' FullHD IPS 144Hz</p>
                              <span>Intel® Core™ i5-12450h (3.3 GHz – 4.4 GHz) (8 yadroli; 12 ip;)</span>
                                <br />
                                <br />
                ...
                <div className='div_about_victus'>
                      <div className='div_about1'>
                          <h2 id='h2'>HP Victus noutbuklarini Toshkentda Nout.uz saytidan sotib oling: geymerlar va professionallar uchun kuch va ishonchlilik</h2>
                          ...
                          <h4>HP ENVY: Ishonchlilik va ishlash</h4>
                          <p>HP ENVY noutbuklari ishonchlilik va ishlashning sinonimidir. Ularning mashhurligining bir necha sabablari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Ishonchlilik: HP Victus yuqori sifatli komponentlar yordamida ishlab chiqarilgan va chidamlilik va ishonchlilik uchun qattiq sinovlardan o’tgan. Ular uzoq muddatli foydalanish uchun mo’ljallangan.</span>                          
                             <br />
                          <span id='span1'>2.   Ishlash: HP Victus noutbuklari kuchli Intel yoki AMD protsessorlari, yuqori unumdor grafik kartalar va ilovalar va vazifalarning uzluksiz ishlashini ta’minlash uchun keng RAM bilan jihozlangan.</span>
                             <br />
                          <span id='span1'>3.   Dizayn va uslub: HP Victus noutbuklarining zamonaviy va nafis dizayni ularni ish va o‘yin uchun jozibador qiladi.</span>
                             <br />
                          <span id='span1'>4.   Modellarning xilma-xilligi: HP Victus har bir mijoz o’z ehtiyojlari va byudjetiga mos keladigan mukammal noutbukni topishini ta’minlash uchun keng turdagi modellarni taklif etadi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda HP Victus sotib olish uchun ishonchli tanlovdir?</h4>
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida HP Victus xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
