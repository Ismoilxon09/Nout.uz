                  ...
                  <div className='header_div'>
                   ...
                   <div className='div_main01 '>
                           <div className='div_main2 overflow-x-auto'>
                              ...
                              <span><i class="fa-solid fa-chevron-right"></i></span>                              
                              <span>Microsoft Surface Noutbuklari</span>
             ...
             <main>
                <div className='carusel_div'>
                    <div className='samsung_progres'>
                        <h1>Microsoft Surface Noutbuklari</h1>
                    </div>
                ...
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Toshkentda Microsoft Surface: Nout.uz saytida sizni birinchi toifadagi noutbuklar kutmoqda.</h2>
                          <p>Kirish: Texnologiya olamida to’g’ri noutbukni tanlash kundalik hayotda asosiy rol o’ynaydi. Microsoft Surface noutbuklari innovatsiya va uslubning timsoli hisoblanadi. Ushbu SEO maqolasida biz Toshkentdagi Microsoft Surface qurilmalarini tanlashda nima uchun Nout.uz sizning ideal hamkoringiz ekanligini aytib beramiz.</p>
                          <p>Nima uchun Microsoft Surface? Microsoft Surface portativ qurilmalar olamida benchmark hisoblanadi. Ushbu noutbuklar quvvat, portativlik va uslubning ajoyib kombinatsiyasini taklif etadi. Microsoft Surface ajoyib unumdorlikdan innovatsion xususiyatlargacha raqamli hayotingizni yanada qulay va samarali qiladi.</p>
                          <p>Nout.uz ning afzalliklari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Keng assortiment: Nout.uz mijozlarning turli talab va istaklarini inobatga olgan holda Microsoft Surface-ning turli modellarini taqdim etadi.</span>                          
                             <br />
                          <span id='span1'>2.   Sifat kafolatlangan: Biz Microsoft kompaniyasining rasmiy hamkorlarimiz, mahsulotning haqiqiyligi va yuqori sifat standartlarini kafolatlaymiz.</span>
                             <br />
                          <span id='span1'>3.   Raqobatbardosh narxlar: Bizning raqobatbardosh narxlarimiz Microsoft Surface qurilmalarini keng auditoriya uchun ochiq qiladi.</span>
                             <br />
                          <span id='span1'>4.   Bepul yetkazib berish: Xarid qilish jarayonini iloji boricha qulay qilish uchun Toshkent bo’ylab bepul yetkazib berishni ta’minlaymiz.</span>
                             <br />
                          <span id='span1'>5.   Moslashuvchan to‘lov shartlari: Nout.uz mijozlarga qulayliklarni hisobga olgan holda turli to‘lov imkoniyatlarini taklif etadi.</span>
                        </div> 
                          <p>Nega Toshkentda? Toshkent zamonaviylik ko’p asrlik an’analar bilan to’qnash kelgan shahardir. Microsoft Surface noutbuklari ilg‘or texnologiyalar va estetikaning mukammal uyg‘unligi bo‘lib, ular ajoyib ishlash va uslubni qadrlaydigan toshkentliklar uchun zarur bo‘ladi.</p>
