             ...
             <main>
                <div className='carusel_div'>
                    ...
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                       <img src="https://nout.uz/wp-content/uploads/2022/06/inspiron3-1536x507.jpg" alt="" />
                    </div>
                </div>
                <hr id='hr1'/>                
                <hr id='dell_hr'/>
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda Dell Inspiron noutbuklarini xarid qiling: Sizning oʻyin va ajoyib ishlash olamiga chiptangiz</h2>
                          <p>Agar siz o’yin o’ynash va mashaqqatli vazifalar uchun mukammal hamroh qidirsangiz, Dell Inspiron noutbuklari sizning eng yaxshi tanlovingizdir. Ushbu maqolada Dell Inspiron noutbuklarining afzalliklari va nima uchun Nout.uz Toshkentda ushbu modelni xarid qilishda ishonchli hamkoringiz ekanligi haqida gapirib beramiz.</p>
                          <h4>Dell Inspiron: O’yin dunyosida</h4>
                          <p>Dell Inspiron noutbuklari geymerlar va maksimal ishlashni qadrlaydiganlar ehtiyojlarini hisobga olgan holda ishlab chiqilgan. Mana nima uchun ular juda mashhur:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Oʻyin samaradorligi: Dell Inspiron kuchli Intel Core yoki AMD Ryzen protsessorlari, yuqori unumdorlikdagi NVIDIA GeForce grafik kartalari va keng operativ xotira bilan jihozlangan boʻlib, sizga yuqori grafik sozlamalarida oʻyinlardan bahramand boʻlish va resurs talab qiluvchi ilovalarni ishga tushirish imkonini beradi.</span>                          
                             <br />
                          <span id='span1'>2.   Tez displey: Dell Inspiron ko‘p modellarida kechikishlarsiz silliq va real o‘yin uchun tez, yuqori yangilanish tezligi displeylari mavjud.</span>
                             <br />
                          <span id='span1'>3.   Tasvir sifati: Dell Inspiron displeylarining yuqori aniqligi va jonli ranglari ularni geymerlar va multimedia kontenti yaratuvchilari uchun ajoyib tanlov qiladi.</span>
                             <br />
                          <span id='span1'>4.   O’ylangan dizayn: Dell Inspiron noutbuklarining nafis va zamonaviy dizayni ularga xarakter beradi va ularni nafaqat samarali, balki jozibali qiladi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Dell Inspiron sotib olish uchun ishonchli tanlovdir?</h4>
                          <p>Nout.uz — Toshkent shahrida yuqori sifatli elektronika, jumladan, Dell Inspiron noutbuklarini sotishga ixtisoslashgan onlayn-do‘kon. Mana nima uchun Nout.uz sizning ideal hamkoringiz:</p>
                          <div className='span'> 
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida DDell Inspiron xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
                                   ...
                                   <span id='span1'>4.Qulay to’lov va yetkazib berish usulini tanlang.</span>
                                     <br />
                                   <span id='span1'>5.Buyurtma kelishini kuting va Dell Inspiron sifatidan bahramand bo’ling.</span>
                                </div> 
                                 <br />
                            <h4>Xulosa</h4>
