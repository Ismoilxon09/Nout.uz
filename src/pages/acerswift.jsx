             ...
             <main>
                <div className='carusel_div'>
                    ...
                    <div className='carusel_div2 animate__bounceIn animate_animated'>
                       <img src="https://nout.uz/wp-content/uploads/2022/06/swift-1536x507.jpg" alt="" />
                    </div>
                 </div>
                <hr id='hr1'/>
                <hr id='hr2'/>
                <div className='div_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda Acer Swift noutbuklarini xarid qiling: Sizning oʻyin va ajoyib ishlash olamiga chiptangiz</h2>
                          ...
                          <h4>Acer Swift: Uslub va Portativlik</h4>
                          <p>Acer Swift noutbuklari zamonaviy dizayni va portativligi bilan mashhur. Ularning mashhurligining bir necha sabablari:</p>
                        <div className='span'> 
                          <span id='span1'>1.   Chiroyli dizayn: Acer Swift nafis va minimalistik dizaynga ega. Ular ish uchun ham, o’yin-kulgi uchun ham jozibali.</span>                          
                             <br />
                          <span id='span1'>2.   Portativlik: Acer Swift noutbuklari engil va ixcham bo’lib, ularni yo’lda bo’lganlar uchun ajoyib tanlov qiladi. Ularni istalgan joyda osongina o’zingiz bilan olib ketishingiz mumkin</span>
                             <br />
                          <span id='span1'>3.   Ishlash: Portativ bo’lishiga qaramay, Acer Swift noutbuklari Intel Core protsessorlari va ilovalar va vazifalarni samarali bajarish uchun yetarlicha operativ xotira bilan jihozlangan.</span>
                             <br />
                          <span id='span1'>4.   Batareya muddati: Acer Swift’ning ko‘pgina modellari uzoq batareya quvvatiga ega, bu sizga doimiy rozetka izlamasdan ishlash yoki o‘ynash imkonini beradi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Acer Swift sotib olish uchun ishonchli tanlovdir?</h4>
