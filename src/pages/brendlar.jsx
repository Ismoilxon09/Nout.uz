             ...
             <main>
                <div className='link_div'>
                     <div className='link_div1'>
                        <Link to="/" id='main-link'>Bosh sahifa</Link>
                         <span><i class="fa-solid fa-chevron-right"></i></span>
                         <span>Brendlar</span>
                     </div>
                </div>
                <div className='rasmlar_div'>
                     <div className='rasmlar_div1'>
                         <div className='rasmlar_div2'>
                             <h1>Brendlar</h1>
                         </div>
                         <div className='Brendlar '>
                              <div className='brendlar row'>
                                  <div className='brend col-xl-2 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/acer"><img src="https://nout.uz/wp-content/uploads/2021/03/acer.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/asus"><img src="https://nout.uz/wp-content/uploads/2021/11/asus-logotype.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/lenovo"><img src="https://nout.uz/wp-content/uploads/2021/03/lenovo.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/msi"><img src="https://nout.uz/wp-content/uploads/2021/03/msi.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/dell"><img src="https://nout.uz/wp-content/uploads/2021/03/dell.png" alt="" /></Link>
                                  </div>                              
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/microsoft"><img src="https://nout.uz/wp-content/uploads/2021/03/microsoft-surface.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/razer"><img src="https://nout.uz/wp-content/uploads/2021/03/razer.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/lg"><img src="https://nout.uz/wp-content/uploads/2021/03/lg.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3 lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/samsung"><img src="https://nout.uz/wp-content/uploads/2021/03/samsung.png" alt="" /></Link>
                                  </div>
                                  <div className='brend col-xl-3  lg-3 md-4 sm-4 bg-primary'>
                                    <Link to="/apple"><img src="https://nout.uz/wp-content/uploads/2021/03/apple.png" alt="" /></Link>
                                  </div>
                              </div>
                              <div className='brendlar1'>
                                <div className='brend1'>
                                 <Link to="/hp"><img src="https://nout.uz/wp-content/uploads/2021/03/hp.png" alt="" /></Link>
                                </div>
                              </div>
                         </div>
                     </div>
