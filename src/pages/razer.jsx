             ...
             <main>
                <div className='acer'>
                    <div className='acer_nout'>
                        <h1>Razer Noutbuklari</h1>
                    </div>
                    <div className='acer_nitro'>
                        <Link >
                          <img id='nitro_img' src="https://nout.uz/wp-content/uploads/2022/06/razer-1-1-1536x390.jpg" alt="" />
                        </Link>
                    </div>
                </div>
                  ...
                  <div className='razer_about'>
                      <div className='div_about1'>
                          <h2 id='h2'>Nout.uz saytida Toshkentda Razer noutbuklarini xarid qiling: Ishonchlilik va innovatsiya uchun sizning tanlovingiz</h2>
                          <p>Noutbuklar haqida gap ketganda, Razer elektronika olamidagi eng ishonchli va innovatsion brendlardan biri hisoblanadi. Agar siz Toshkentda bo’lsangiz va noutbuk sotib olish imkoniyatlarini ko’rib chiqayotgan bo’lsangiz, Nout.uz saytidagi Acer noutbuklari sizning eng yaxshi tanlovingizdir. Ushbu maqolada Acer noutbuklarining afzalliklari va nima uchun Nout.uz Toshkentda ushbu brendni xarid qilishda ishonchli hamkoringiz ekanligi haqida gapirib beramiz.</p>
                          <h4>Razer: Ishonchlilik va innovatsiya</h4>
                          <p>Razer innovatsion funksiyalar va texnologiyalarni taklif qiluvchi ishonchli va yuqori sifatli noutbuklari bilan mashhur. Acer noutbuklariga e’tibor berishingizning asosiy sabablaridan ba’zilari:</p>
                        <div className='span'> 
                          <span id='span1'>1.  Ishonchlilik: Razer noutbuklari yuqori sifatli komponentlar yordamida ishlab chiqariladi va chidamlilik va ishonchlilik uchun jiddiy sinovlardan o’tgan. Ular uzoq muddatli foydalanish uchun mo’ljallangan.</span>                          
                             <br />
                             <br />
                          <span id='span1'>2.   Innovatsiyalar: Razer doimiy ravishda foydalanuvchilarga noutbuklar dunyosidagi eng ilg‘or yechimlarni taqdim etish uchun yangi texnologiyalarni ishlab chiqishga sarmoya kiritadi. Siz innovatsion xususiyatlar va yuqori unumdorlikka ega bo’lasiz.</span>
                             <br />
                             <br />
                          <span id='span1'>3.  Modellarning xilma-xilligi: Razer turli ehtiyojlar va byudjetlarga mos keladigan noutbuklarning keng assortimentini taklif etadi. Sizning talablaringizga mos keladigan mukammal noutbukni topishingiz mumkin.</span>
                             <br />
                             <br />
                          <span id='span1'>4.  Zamonaviy dizayn: Razerning ko’plab modellari zamonaviy va zamonaviy dizaynga ega bo’lib, ularni ish va o’yin uchun jozibador qiladi.</span>
                        </div> 
                          <h4>Nega Nout.uz Toshkentda Razer noutbuklarini xarid qilishda ishonchli tanlovdir?</h4>
                          <p>Nout.uz — Toshkentda elektronika, jumladan, Razer noutbuklarini sotishga ixtisoslashgan internet-do‘kon. Nout.uz sizning ideal hamkoringiz bo’lishining sabablari:</p>
                          <div className='span'> 
                          ...
                          <span id='span1'>4.Professional xizmat: Bizning tajribali texnik xodimlarimiz sizga to’g’ri modelni tanlashda yordam berishga va savollaringizga javob berishga doimo tayyor.</span>
                           ...
                           <span>Nout.uz saytida Razer noutbukini xarid qilish oddiy va qulay:</span>
                                <div className='span'> 
                                   <span id='span1'>1.<Link to="/">Nout.uz</Link> saytimizga tashrif buyuring.</span>                          
                                      <br />
                                   <span id='span1'>2.Sizni qiziqtirgan Razer modelini tanlang.</span>
                                      <br />
                                   ...
                                   <span id='span1'>4.Qulay to’lov va yetkazib berish usulini tanlang.</span>
                                     <br />
                                   <span id='span1'>5.Buyurtma kelishini kuting va Razer sifatidan bahramand bo’ling.</span>
                                </div> 
                                 <br />
                          <h4>Xulosa</h4>
                            <span>Nout.uz saytida Razer noutbukini xarid qilish sizning ishonchlilik va innovatsiyalar sari qadamdir. Sifatli va ishonchli noutbuk olish imkoniyatini boy bermang. Bizning veb-saytimizga tashrif buyuring va bugun buyurtma bering!</span>
